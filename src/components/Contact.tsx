            ...
            {submitted ? (
              ...
              >
                <motion.div
                  ...
                  className="w-20 h-20 rounded-full bg-brand-50 flex items-center justify-center mb-6"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  >
                    ...
                    <div className="input-focus-effect relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand/30 transition-all duration-200"
                      />
                    </div>
                  </motion.div>
                ))}
                ...
                >
                  ...
                  <div className="input-focus-effect relative">
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand/30 transition-all duration-200 resize-none"
                    />
                  </div>
                </motion.div>
                ...
                >
                  <button
                    type="submit"
                    className="shimmer-btn w-full bg-brand text-white py-3.5 rounded-xl font-semibold text-base hover:bg-brand-light transition-colors duration-200"
                  >
                    Send Message
                  </button>
                </motion.div>
